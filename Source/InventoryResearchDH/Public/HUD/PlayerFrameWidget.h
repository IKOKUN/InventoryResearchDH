...
#include "PlayerFrameWidget.generated.h"
 ...
 */
UCLASS()
class INVENTORYRESEARCHDH_API UPlayerFrameWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UPlayerFrameWidget(const FObjectInitializer& ObjectInitializer);
